...
test("every real catalog game has a real, sourced Game Guide", () => {
    ...
    // list ahead of that.
    assert.strictEqual(GAME_GUIDES.length, 97);

    assert.deepStrictEqual(
        GAME_GUIDES.map(guide => guide.gameSlug).sort(),
        ["a-hat-in-time", "a-little-to-the-left", "a-short-hike", "ark-survival-evolved", "astral-ascent", "baba-is-you", "baldurs-gate-3", "bastion", "braid", "celeste", "chained-echoes", "chicory", "civilization-vi", "crypt-of-the-necrodancer", "cult-of-the-lamb", "cuphead", "curse-of-the-dead-gods", "cyberpunk-2077", "dark-souls-3", "darkest-dungeon", "dave-the-diver", "dead-cells", "deaths-door", "deep-rock-galactic", "disco-elysium", "dome-keeper", "dorfromantik", "dredge", "dying-light", "elden-ring", "enter-the-gungeon", "fallout-new-vegas", "frostpunk", "ftl", "furi", "garrys-mod", "god-of-war", "grand-theft-auto-v", "griftlands", "guacamelee-2", "hades", "half-life-2", "hollow-knight", "hyper-light-drifter", "inside", "into-the-breach", "left-4-dead", "left-4-dead-2", "limbo", "little-nightmares", "loop-hero", "mark-of-the-ninja", "moonlighter", "neon-abyss", "neon-white", "no-mans-sky", "ori-and-the-blind-forest", "ori-and-the-will-of-the-wisps", "owlboy", "oxenfree", "palworld", "papers-please", "phasmophobia", "pizza-tower", "portal", "portal-2", "pyre", "red-dead-redemption-2", "return-of-the-obra-dinn", "rime", "risk-of-rain-2", "rogue-legacy", "rust", "sable", "satisfactory", "sea-of-thieves", "sekiro", "sifu", "skyrim-special-edition", "slay-the-spire", "spelunky-2", "stardew-valley", "steamworld-dig-2", "streets-of-rogue", "superliminal", "terraria", "the-forest", "the-forgotten-city", "the-messenger", "the-stanley-parable", "the-witcher-3", "thomas-was-alone", "transistor", "va11-hall-a", "vampire-survivors", "void-bastards", "what-remains-of-edith-finch"]
    );

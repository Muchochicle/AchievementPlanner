...
test("every real catalog game has a real, sourced Game Guide", () => {
    ...
    // list ahead of that.
    assert.strictEqual(GAME_GUIDES.length, 355);

    assert.deepStrictEqual(
        GAME_GUIDES.map(guide => guide.gameSlug).sort(),
        ["20-minutes-till-dawn", "7-billion-humans", "7-days-to-die", "a-hat-in-time", "a-little-to-the-left", "a-short-hike", "a-way-out", "against-the-storm", "age-of-empires-1-de", "age-of-empires-2-de", "age-of-empires-4", "age-of-mythology-retold", "age-of-wonders-3", "alien-isolation", "aliens-fireteam-elite", "ark-survival-evolved", "astral-ascent", "atomic-heart", "automation-empire", "autonauts", "baba-is-you", "back-4-blood", "backpack-battles", "backpack-hero", "bad-north", "balatro", "baldurs-gate-3", "banished", "barotrauma", "bastion", "batman-arkham-asylum", "batman-arkham-city", "battle-brothers", "battlefield-1", "bayonetta", "beamng-drive", "besiege", "bioshock-infinite", "bioshock-remastered", "bloons-td-6", "book-of-demons", "borderlands-2", "braid", "bright-memory-infinite", "brotato", "brothers-a-tale-of-two-sons", "car-mechanic-simulator-2021", "celeste", "chained-echoes", "chicory", "chivalry-2", "chivalry-medieval-warfare", "cities-skylines", "cities-skylines-2", "civilization-5", "civilization-vi", "colony-survival", "company-of-heroes-2", "company-of-heroes-3", "content-warning", "counter-strike-source", "craft-the-world", "crusader-kings-3", "crypt-of-the-necrodancer", "cult-of-the-lamb", "cuphead", "curse-of-the-dead-gods", "cyber-shadow", "cyberpunk-2077", "dark-souls-3", "darkest-dungeon", "dave-the-diver", "dawn-of-man", "days-gone", "dead-cells", "dead-island-definitive-edition", "dead-rising-3", "dead-space-2023", "deaths-door", "deep-rock-galactic", "deep-rock-galactic-survivor", "devil-may-cry-5", "devil-may-cry-hd-collection", "devour", "dinkum", "dirt-4", "dirt-rally-2", "disco-elysium", "dishonored", "dmc-devil-may-cry", "dome-keeper", "doom-1993", "doom-2016", "doom-eternal", "dorfromantik", "dragon-age-inquisition", "dredge", "duck-game", "dying-light", "dyson-sphere-program", "ea-sports-fc-24", "elden-ring", "endless-space-2", "enshrouded", "enter-the-gungeon", "euro-truck-simulator-2", "europa-universalis-4", "everspace-2", "f1-24", "factorio", "fall-guys", "fallout-76", "fallout-new-vegas", "far-cry-3", "far-cry-5", "farming-simulator-22", "fields-of-mistria", "firewatch", "football-manager-2024", "for-honor", "forza-horizon-5", "forza-motorsport-2023", "frostpunk", "ftl", "furi", "garrys-mod", "ghostrunner", "god-of-war", "going-medieval", "grand-theft-auto-v", "green-hell", "griftlands", "grounded", "guacamelee-2", "gunfire-reborn", "hades", "hades-2", "half-life-2", "hearts-of-iron-4", "helldivers-2", "helldivers-dive-harder", "hitman-world-of-assassination", "hogwarts-legacy", "hollow-knight", "hotline-miami", "human-fall-flat", "human-resource-machine", "huntdown", "hyper-light-drifter", "inside", "insurgency", "insurgency-sandstorm", "into-the-breach", "islanders", "it-takes-two", "journey", "just-cause-2", "just-cause-4", "killing-floor", "killing-floor-2", "kingdom-two-crowns", "left-4-dead", "left-4-dead-2", "like-a-dragon-ishin", "limbo", "little-nightmares", "loop-hero", "luck-be-a-landlord", "mad-max", "mafia-2-definitive-edition", "mafia-definitive-edition", "manor-lords", "mark-of-the-ninja", "marvel-rivals", "marvels-midnight-suns", "mass-effect-legendary-edition", "metal-gear-rising-revengeance", "metal-hellsinger", "metro-2033-redux", "metro-exodus", "mini-metro", "monster-hunter-rise", "monster-hunter-world", "monster-train", "moonlighter", "mortal-kombat-1", "mortal-kombat-11", "mount-and-blade-2-bannerlord", "mount-and-blade-warband", "muck", "mudrunner", "my-summer-car", "naraka-bladepoint", "necesse", "neon-abyss", "neon-white", "nidhogg", "nightingale", "nioh-2", "no-mans-sky", "northgard", "nova-drift", "once-human", "ori-and-the-blind-forest", "ori-and-the-will-of-the-wisps", "overcooked-2", "owlboy", "oxenfree", "oxygen-not-included", "palworld", "papers-please", "party-animals", "path-of-exile", "payday-3", "peak", "peglin", "people-playground", "persona-5-royal", "phasmophobia", "pillars-of-eternity", "pizza-tower", "planet-zoo", "plateup", "portal", "portal-2", "powerwash-simulator", "prey-2017", "prison-architect", "project-highrise", "psychonauts", "pubg-battlegrounds", "pyre", "raft", "rage-2", "railway-empire", "rainbow-six-siege", "rayman-legends", "ready-or-not", "red-dead-redemption-2", "red-faction-guerrilla-remastered", "resident-evil-2-remake", "resident-evil-4-remake", "resident-evil-village", "return-of-the-obra-dinn", "rime", "rise-of-the-tomb-raider", "risk-global-domination", "risk-of-rain", "risk-of-rain-2", "rivals-of-aether", "rocket-league", "rogue-legacy", "rust", "sable", "saints-row-the-third", "satisfactory", "scp-secret-laboratory", "sea-of-thieves", "sekiro", "serious-sam-4", "shadow-of-mordor", "shadow-of-war", "shadow-warrior-3", "shovel-knight", "sifu", "skyrim-special-edition", "slay-the-spire", "sleeping-dogs", "slime-rancher", "slime-rancher-2", "sniper-elite-3", "sniper-elite-4", "sniper-elite-5", "snowrunner", "songs-of-syx", "space-marine-2", "speedrunners", "spelunky-2", "stardew-valley", "steamworld-dig-2", "stellaris", "street-fighter-6", "streets-of-rage-4", "streets-of-rogue", "subnautica", "subnautica-below-zero", "sun-haven", "sunless-sea", "sunset-overdrive", "superliminal", "surviving-mars", "team-fortress-2", "techtonica", "terraria", "the-crew-2", "the-first-descendant", "the-forest", "the-forgotten-city", "the-last-of-us-part-1", "the-messenger", "the-planet-crafter", "the-riftbreaker", "the-stanley-parable", "the-witcher-2", "the-witcher-3", "they-are-billions", "thomas-was-alone", "titan-quest", "titanfall-2", "tomb-raider-2013", "total-war-rome-2", "total-war-shogun-2", "total-war-three-kingdoms", "total-war-warhammer", "total-war-warhammer-2", "total-war-warhammer-3", "towerfall", "transistor", "transport-fever-2", "trine-2", "trine-4", "trine-5", "trombone-champ", "tropico-6", "two-point-hospital", "ultimate-chicken-horse", "unrailed", "unravel-two", "v-rising", "va11-hall-a", "vampire-survivors", "victoria-3", "viscera-cleanup-detail", "void-bastards", "wallpaper-engine", "war-thunder", "warframe", "warhammer-40k-boltgun", "warhammer-40k-darktide", "warhammer-vermintide-2", "wartales", "watch-dogs-2", "watch-dogs-legion", "what-remains-of-edith-finch", "wildermyth", "wildfrost", "wingspan", "wizard-of-legend", "wobbly-life", "wolfenstein-2", "wolfenstein-the-old-blood", "world-of-goo", "world-war-z", "yakuza-like-a-dragon", "yooka-laylee"]
    );

...
test("every real catalog game has a real, sourced Game Guide", () => {
    ...
    // list ahead of that.
    assert.strictEqual(GAME_GUIDES.length, 211);

    assert.deepStrictEqual(
        GAME_GUIDES.map(guide => guide.gameSlug).sort(),
        ["20-minutes-till-dawn", "7-days-to-die", "a-hat-in-time", "a-little-to-the-left", "a-short-hike", "against-the-storm", "age-of-empires-1-de", "age-of-empires-2-de", "age-of-empires-4", "age-of-mythology-retold", "ark-survival-evolved", "astral-ascent", "atomic-heart", "baba-is-you", "backpack-battles", "balatro", "baldurs-gate-3", "barotrauma", "bastion", "batman-arkham-city", "beamng-drive", "bioshock-infinite", "bioshock-remastered", "bloons-td-6", "borderlands-2", "braid", "brotato", "celeste", "chained-echoes", "chicory", "cities-skylines", "cities-skylines-2", "civilization-5", "civilization-vi", "company-of-heroes-2", "content-warning", "counter-strike-source", "crusader-kings-3", "crypt-of-the-necrodancer", "cult-of-the-lamb", "cuphead", "curse-of-the-dead-gods", "cyberpunk-2077", "dark-souls-3", "darkest-dungeon", "dave-the-diver", "dead-cells", "deaths-door", "deep-rock-galactic", "deep-rock-galactic-survivor", "devil-may-cry-5", "devour", "dinkum", "dirt-rally-2", "disco-elysium", "dishonored", "dome-keeper", "doom-1993", "doom-2016", "doom-eternal", "dorfromantik", "dredge", "dying-light", "dyson-sphere-program", "ea-sports-fc-24", "elden-ring", "enshrouded", "enter-the-gungeon", "euro-truck-simulator-2", "f1-24", "factorio", "fall-guys", "fallout-new-vegas", "far-cry-3", "far-cry-5", "farming-simulator-22", "football-manager-2024", "forza-horizon-5", "frostpunk", "ftl", "furi", "garrys-mod", "ghostrunner", "god-of-war", "grand-theft-auto-v", "green-hell", "griftlands", "grounded", "guacamelee-2", "gunfire-reborn", "hades", "half-life-2", "hearts-of-iron-4", "helldivers-2", "hitman-world-of-assassination", "hogwarts-legacy", "hollow-knight", "hotline-miami", "human-fall-flat", "hyper-light-drifter", "inside", "insurgency-sandstorm", "into-the-breach", "just-cause-4", "left-4-dead", "left-4-dead-2", "limbo", "little-nightmares", "loop-hero", "mad-max", "mafia-2-definitive-edition", "mafia-definitive-edition", "mark-of-the-ninja", "marvel-rivals", "metro-2033-redux", "metro-exodus", "monster-hunter-rise", "monster-hunter-world", "moonlighter", "mortal-kombat-1", "mortal-kombat-11", "mount-and-blade-2-bannerlord", "naraka-bladepoint", "neon-abyss", "neon-white", "nioh-2", "no-mans-sky", "ori-and-the-blind-forest", "ori-and-the-will-of-the-wisps", "overcooked-2", "owlboy", "oxenfree", "oxygen-not-included", "palworld", "papers-please", "party-animals", "payday-3", "phasmophobia", "pizza-tower", "planet-zoo", "portal", "portal-2", "powerwash-simulator", "prison-architect", "pubg-battlegrounds", "pyre", "raft", "rage-2", "ready-or-not", "red-dead-redemption-2", "resident-evil-2-remake", "resident-evil-4-remake", "resident-evil-village", "return-of-the-obra-dinn", "rime", "rise-of-the-tomb-raider", "risk-of-rain-2", "rocket-league", "rogue-legacy", "rust", "sable", "satisfactory", "sea-of-thieves", "sekiro", "shadow-of-mordor", "shadow-of-war", "sifu", "skyrim-special-edition", "slay-the-spire", "sleeping-dogs", "slime-rancher", "sniper-elite-5", "spelunky-2", "stardew-valley", "steamworld-dig-2", "stellaris", "streets-of-rogue", "sun-haven", "superliminal", "team-fortress-2", "terraria", "the-forest", "the-forgotten-city", "the-last-of-us-part-1", "the-messenger", "the-stanley-parable", "the-witcher-2", "the-witcher-3", "they-are-billions", "thomas-was-alone", "tomb-raider-2013", "total-war-rome-2", "total-war-three-kingdoms", "total-war-warhammer-2", "total-war-warhammer-3", "transistor", "two-point-hospital", "v-rising", "va11-hall-a", "vampire-survivors", "void-bastards", "wallpaper-engine", "war-thunder", "warhammer-40k-boltgun", "warhammer-40k-darktide", "warhammer-vermintide-2", "watch-dogs-2", "watch-dogs-legion", "what-remains-of-edith-finch", "wolfenstein-2", "yakuza-like-a-dragon"]
    );

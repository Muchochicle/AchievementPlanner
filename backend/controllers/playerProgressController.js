...
export async function putProgress(req, res) {
    ...
    return putProgressWithDeps(req, res, { getLeaderboardDb, savePlayerProgress });

}

export async function putProgressWithDeps(req, res, deps) {

    const { getLeaderboardDb, savePlayerProgress } = deps;
    ...
    try {
        ...
        const db = getLeaderboardDb();
        const updatedAt = savePlayerProgress(db, steamId, serialized);

...
test("GET /api/games returns the real catalog games with hasPlanner:true and the expected count/games shape", async () => {
    ...
    await withServer({}, async ({ baseUrl }) => {
        ...
        assert.deepStrictEqual(slugs, ["a-hat-in-time", "a-short-hike", "bastion", "braid", "celeste", "cuphead", "dead-cells", "disco-elysium", "hades", "hollow-knight", "hyper-light-drifter", "inside", "limbo", "ori-and-the-blind-forest", "papers-please", "portal", "portal-2", "return-of-the-obra-dinn", "rime", "slay-the-spire", "stardew-valley", "superliminal", "the-stanley-parable", "transistor", "what-remains-of-edith-finch"]);

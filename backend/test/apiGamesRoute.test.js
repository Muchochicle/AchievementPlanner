...
test("GET /api/games returns the real catalog games with hasPlanner:true and the expected count/games shape", async () => {
    ...
    await withServer({}, async ({ baseUrl }) => {
        ...
        assert.deepStrictEqual(slugs, ["braid", "celeste", "hades", "hollow-knight", "inside", "limbo", "ori-and-the-blind-forest", "portal", "portal-2", "return-of-the-obra-dinn", "stardew-valley", "what-remains-of-edith-finch"]);

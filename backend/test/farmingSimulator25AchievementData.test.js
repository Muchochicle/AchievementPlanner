...
// backend/catalog/games/farming-simulator-25.json - 45 real achievements sourced
// from a live ISteamUserStats/GetSchemaForGame/v2 response for appid
// 2300320 (fetched through this app's own services/steamApi.js). None are
// hidden; every description is Steam's own real text.
// Hidden achievements have no Steam description; where present, their
// description here is researched from community 100% guides and cited in
// the frontend guide header. difficulty/estimatedTime/missable are curatorial.
const game = getPlannerData("farming-simulator-25");

test("getPlannerData('farming-simulator-25') returns real planner data with 45 curated achievements", () => {

    assert.ok(game, "expected real planner data for farming-simulator-25");
    assert.ok(Array.isArray(game.achievements));
    assert.strictEqual(game.achievements.length, 45);

});

test("every Farming Simulator 25 achievement has a unique id from 1 to 45 and a unique apiname", () => {
...
test("every Farming Simulator 25 achievement has a valid difficulty (1-5), a positive estimatedTime, and non-empty name/description", () => {
...
test("every one of the 45 Farming Simulator 25 achievement name+description pairs matches the catalog data", () => {
    ...
    const officialAchievements = [
        ...
        ["Fluffiness", "Building up my wool empire."],
        ...
        ["Over 9000!", "With the power of farm balls for even more yield."],
        ...
        ["Tutti-Frutti", "The legend of the golden apple."],

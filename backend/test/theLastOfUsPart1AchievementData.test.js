...
// backend/catalog/games/the-last-of-us-part-1.json - 29 real achievements sourced
// from a live ISteamUserStats/GetSchemaForGame/v2 response for appid
// 1888930 (fetched through this app's own services/steamApi.js).
// This game has no hidden achievements: all 29 ship a real, official
// Steam description, quoted verbatim below.
// difficulty/estimatedTime/missable remain curatorial judgments.
const game = getPlannerData("the-last-of-us-part-1");

test("getPlannerData('the-last-of-us-part-1') returns real planner data with 29 curated achievements", () => {

    assert.ok(game, "expected real planner data for the-last-of-us-part-1");
...
test("every one of the 29 The Last of Us Part I achievement name+description pairs matches the live GetSchemaForGame response", () => {

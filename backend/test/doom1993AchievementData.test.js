...
// backend/catalog/games/doom-1993.json - 33 real achievements sourced
// from a live ISteamUserStats/GetSchemaForGame/v2 response for appid
// 2280 (fetched through this app's own services/steamApi.js).
// This game has no hidden achievements: all 33 ship a real, official
// Steam description, quoted verbatim below.
// difficulty/estimatedTime/missable remain curatorial judgments.
const game = getPlannerData("doom-1993");

test("getPlannerData('doom-1993') returns real planner data with 33 curated achievements", () => {

    assert.ok(game, "expected real planner data for doom-1993");
...
test("every one of the 33 DOOM + DOOM II achievement name+description pairs matches the live GetSchemaForGame response", () => {
